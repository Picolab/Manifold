...
class SmartMirrorCardView extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div>
        ...
        <Container className="appListContainer">
          ...
          <Col className="saveButtonColumn">
...
export default connect(mapStateToProps, mapDispatchToProps)(SmartMirrorCardView);
