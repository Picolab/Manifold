      ...
      out.push(
        <div>
          <ListGroupItem style={{"padding": "1rem 1.25rem"}}>
            ...
            <a href={`/#/mythings/${this.state.notifications[item].did}/${this.state.notifications[item].ruleset}`} onClick={this.toggle}><i id={"open" + this.state.notifications[item].message} className="fa fa-sign-in float-right fa-lg manifoldDropdown" /></a>
